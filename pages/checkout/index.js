        ...
        <Layout>
            <div className="p-5">
                ...
                <div className="flex flex-col lg:flex-row justify-between mt-8 rounded-md border">
                     {/* NEW CONTENT */}
                    <form className="flex-initial w-full lg:w-3/5 order-last lg:order-none p-6 px-8">
                        <div className="space-y-6">
                            ...
                            <div className="pb-5">
                                ...
                                <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <label for="street-address" className="block text-sm font-medium leading-6 text-gray-900">Phone number</label>
                                    <div className="mt-2">
                                    ...
                                    <div className="sm:col-span-3 sm:col-start-1">
                                    <label for="region" className="block text-sm font-medium leading-6 text-gray-900">State</label>
                                    <div className="mt-2">
                            ...
                            <div className="pb-5">
                                ...
                                <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div className="col-span-full">
                                        <label for="card-number" className="block text-sm font-medium leading-6 text-gray-900">Card number</label>
                                        <div className="mt-2">
                                    ...
                                    <div className="sm:col-span-4">
                                        <label for="expiration-date" className="block text-sm font-medium leading-6 text-gray-900">Expiration date (MM/YY)</label>
                                        <div className="mt-2">
                                    ...
                                    <div className="sm:col-span-2">
                                        <label for="cvc" className="block text-sm font-medium leading-6 text-gray-900">CVC</label>
                                        <div className="mt-2">
                        ...
                        <div className="mt-6 flex items-center justify-end gap-x-6">
                            <button type="submit" className="rounded-md bg-[#0071dc] px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Pay now</button>
                        </div>
                    ...
                    {/* END - NEW CONTENT */}
                    <div className="flex-initial w-full lg:w-2/5 order-first lg:order-none bg-[#f9fafb] p-6 px-8">
