          ...
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-10">
                ...
                <button onClick={() => dispatch(addToCart(product[0]))} className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-[#0071dc] px-8 py-3 text-base font-medium text-white transition hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Add to cart</button>
              </div>
            </div>
